...
def validate_cmakelist_path(cmake_filepath: Path,
    ...
    if cmake_generator_name.is_single_profile():
        ...
        assert cmake_filepath.parent.parent.parent.parent.parent.name == toolchain.target.name
        ...
        assert cmake_filepath.parent.parent.parent.name == toolchain.compiler.name
        assert cmake_filepath.parent.parent.parent.parent.name == toolchain.target.name
    else:
        assert False
