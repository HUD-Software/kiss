namespace Kiss.Generator
{
    ...
    {
        VISUAL_STUDIO_2022_BUILDTOOL,
        VISUAL_STUDIO_2022_COMMUNITY
    }

    public static class GeneratorTypeExtensions
    {
        const string VISUAL_STUDIO_2022_BUILDTOOL = "Visual Studio 2022 BuildTool";
        ...
        {
            VISUAL_STUDIO_2022_BUILDTOOL => GeneratorType.VISUAL_STUDIO_2022_BUILDTOOL,
